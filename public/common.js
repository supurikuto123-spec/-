...
if (typeof window.i18nCommon === 'undefined') {
  ...
  ja: {
    ...
    newsItem1Badge: 'お知らせ',
    newsItem1Title: 'サービス調整中のお知らせ',
    newsItem1Text1: 'いつも<strong>Sutemeado</strong>をご利用いただき、ありがとうございます。',
    newsItem1Text2: '現在、<span style="color: var(--neon-cyan);">サービスの調整中</span>のため、頻繁に更新を行っております。',
    newsItem1Text3: 'そのため、一時的に<span style="color: var(--neon-magenta);">つながりにくかったり</span>、ご利用できない場合や、<span style="color: var(--neon-magenta);">不具合が発生する可能性</span>がございます。',
    newsItem1Text4: 'ご理解いただけますと幸いです。',
    newsItem1Text5: 'ご不明な点やお問い合わせがございましたら、<a href="/contact.html">お問い合わせ</a>からご連絡ください。',
    newsItem2Date: '2026年3月27日',
    newsItem2Badge: 'リリース',
    newsItem2Title: 'Sutemeado サービス開始',
    newsItem2Text1: '<strong>Sutemeado</strong>（捨てメアド）がサービスを開始しました。',
    newsItem2Text2: '登録不要で簡単に使い捨てのメールアドレスが作成できる、<span style="color: var(--neon-cyan);">プライバシー重視の一時メールサービス</span>です。',
    ...
    mainTitle: '捨てメアド｜無料で使える使い捨てメール【即時発行・登録不要】',
    mainDescription: '捨てメアドなら登録不要で無料。メールアドレスを即時発行、迷惑メール対策・個人情報保護に最適。スマホ・PC対応の使い捨てメールサービス。パスワード保存でいつでも再アクセス可能です。',
    metaKeywords: '捨てメアド,使い捨てメール,一時メール,捨てアド,仮メールアドレス,登録不要,無料,temp mail,匿名メール,迷惑メール防止,プライバシー保護,Twitter,Amazon,認証コード',
    ogTitle: '捨てメアド｜無料・登録不要の使い捨てメール',
    ogDescription: '「捨てメアド」で個人情報なしで即時発行。Twitter認証、ショッピング登録の迷惑メール対策に。完全無料・スマホ対応',
    ...
    to: 'To:',
    date: 'Date:',
    // API modal translations
    apiBaseUrl: 'Base URL',
    apiRateLimit: 'Rate Limit',
    apiRateLimitValue: '100件/分',
    apiAuth: '認証',
    apiAuthDesc: 'メールボックス操作にはパスワードが必要です（POSTボディ）',
    apiNewAddress: '新規アドレスを作成',
    apiNewAddressDesc: '新しい一時メールアドレスを作成します',
    apiLogin: 'ログイン（アドレスとパスワードで認証）',
    apiLoginDesc: '既存のアドレスにパスワードでアクセス',
    apiGetMails: 'メール一覧を取得',
    apiGetMailsDesc: '受信箱のメール一覧を取得',
    apiGetMail: '特定のメールを取得',
    apiGetMailDesc: '指定したIDのメール詳細を取得',
    apiDeleteMail: 'メールを削除',
    apiDeleteMailDesc: '特定のメールを削除',
    apiDeleteAll: '全メールを削除',
    apiDeleteAllDesc: '受信箱を空にする',
    apiDeleteAddress: 'アドレスを削除',
    apiDeleteAddressDesc: 'アドレスと全メールを削除',
    apiChangePassword: 'パスワードを変更',
    apiChangePasswordDesc: 'アドレスのパスワードを変更',
    // New address modal
    newAddrModalTitle: '新しいメールアドレスを作成',
    newAddrModalMsg: 'ログイン情報を保存していない場合、現在のアドレスにはアクセスできなくなります。\n\n今後このアドレスを利用しない場合は、削除してから新規作成することを推奨します。',
    newAddrCancel: '戻る',
    newAddrCreate: '作成する',
    newAddrDelete: '削除する',
    // Theme
    themeToggleLabel: 'ライトモード',
    // Subpage titles
    termsTitle: '利用規約',
  ...
  en: {
    ...
    newsItem1Title: 'Service Adjustment Notice',
    newsItem1Text1: 'Thank you for using <strong>Sutemeado</strong>.',
    ...
    mainTitle: 'Temp Mail | Free Disposable Email [Instant Issue, No Registration]',
    mainDescription: 'Get free temp mail without registration. Instantly create disposable email addresses for spam protection and privacy. Works on mobile and PC. Access anytime with saved password.',
    metaKeywords: 'temp mail,disposable email,temporary email,throwaway email,no registration,free,tempmail,anonymous email,spam protection,privacy,Twitter,Amazon,verification code',
    ogTitle: 'Temp Mail | Free Disposable Email Without Registration',
    ogDescription: 'Create instant temp mail without personal info. Perfect for Twitter verification, shopping signups, and spam protection. Completely free, mobile-friendly.',
    // index.html main content
    ...
    apiBaseUrl: 'Base URL',
    apiRateLimit: 'Rate Limit',
    apiRateLimitValue: '100 requests/minute',
    apiAuth: 'Authentication',
    apiAuthDesc: 'Password required for mailbox operations (POST body)',
    apiNewAddress: 'Create New Address',
    apiNewAddressDesc: 'Create a new temporary email address',
    apiLogin: 'Login (authenticate with address and password)',
    apiLoginDesc: 'Access existing address with password',
    apiGetMails: 'Get Mail List',
    apiGetMailsDesc: 'Retrieve inbox mail list',
    apiGetMail: 'Get Specific Mail',
    apiGetMailDesc: 'Get mail details by ID',
    apiDeleteMail: 'Delete Mail',
    apiDeleteMailDesc: 'Delete a specific email',
    apiDeleteAll: 'Delete All Mails',
    apiDeleteAllDesc: 'Empty the inbox',
    apiDeleteAddress: 'Delete Address',
    apiDeleteAddressDesc: 'Delete address and all emails',
    apiChangePassword: 'Change Password',
    apiChangePasswordDesc: 'Change address password',
    // New address modal
    newAddrModalTitle: 'Create New Email Address',
    newAddrModalMsg: 'If you have not saved your login information, you will no longer be able to access your current address.\n\nIf you do not plan to use this address in the future, we recommend deleting it before creating a new one.',
    newAddrCancel: 'Go Back',
    newAddrCreate: 'Create',
    newAddrDelete: 'Delete',
    // Theme
